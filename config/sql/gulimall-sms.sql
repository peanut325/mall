...
Source Database       : gulimall-sms

Target Server Type    : MYSQL
Target Server Version : 50736
File Encoding         : 65001

Date: 2022-06-29 10:28:54
*/
...
CREATE TABLE `sms_seckill_promotion` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='秒杀活动';

-- ----------------------------
-- Records of sms_seckill_promotion
-- ----------------------------
INSERT INTO `sms_seckill_promotion` VALUES ('1', '手机大秒杀', '2022-06-26 00:00:00', '2022-07-01 00:00:00', '1', null, null);
INSERT INTO `sms_seckill_promotion` VALUES ('2', '袜子秒杀', '2022-06-26 00:03:00', '2022-07-27 00:06:00', '1', null, null);
...
-- ----------------------------
INSERT INTO `sms_seckill_session` VALUES ('1', '电脑0点秒杀活动', '2022-06-27 11:00:00', '2022-06-28 00:00:00', '1', '2022-06-26 10:02:56');
INSERT INTO `sms_seckill_session` VALUES ('2', '手机秒杀', '2022-06-27 11:08:41', '2022-06-29 15:08:51', '1', '2022-06-28 11:07:18');
INSERT INTO `sms_seckill_session` VALUES ('3', '装备秒杀', '2022-06-27 11:08:17', '2022-06-29 11:09:24', '1', null);
INSERT INTO `sms_seckill_session` VALUES ('4', '皮肤秒杀', '2022-06-27 11:09:40', '2022-06-27 11:09:48', '1', null);
...
CREATE TABLE `sms_seckill_sku_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='秒杀活动商品关联';

-- ----------------------------
-- Records of sms_seckill_sku_relation
-- ----------------------------
INSERT INTO `sms_seckill_sku_relation` VALUES ('1', '1', '1', '51', '2', '50', '1', '1');
INSERT INTO `sms_seckill_sku_relation` VALUES ('2', '2', '2', '52', '33', '10', '1', '1');
INSERT INTO `sms_seckill_sku_relation` VALUES ('3', '3', '3', '51', '33', '22', '1', '1');
INSERT INTO `sms_seckill_sku_relation` VALUES ('4', '3', '3', '53', '11', '11', '2', '1');
INSERT INTO `sms_seckill_sku_relation` VALUES ('5', '4', '4', '51', '32', '11', '1', '1');
...
CREATE TABLE `sms_sku_full_reduction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COMMENT='商品满减信息';

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES ('25', '51', '0.0000', '0.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('26', '52', '0.0000', '0.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('27', '53', '0.0000', '0.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('28', '54', '0.0000', '0.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('29', '55', '0.0000', '0.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('30', '56', '0.0000', '0.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('31', '57', '0.0000', '0.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('32', '58', '0.0000', '0.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('33', '59', '0.0000', '0.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('34', '60', '0.0000', '0.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('35', '61', '0.0000', '0.0000', null);
INSERT INTO `sms_sku_full_reduction` VALUES ('36', '62', '0.0000', '0.0000', null);
...
CREATE TABLE `sms_spu_bounds` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='商品spu积分设置';

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
INSERT INTO `sms_spu_bounds` VALUES ('1', '27', '2.0000', '5.0000', null);
INSERT INTO `sms_spu_bounds` VALUES ('3', '29', '2.0000', '5.0000', null);
